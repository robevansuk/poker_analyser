 ...
 */
public class PlayerCheckFlopDetailedHandTypeSuccessReport extends Report {
    ...
    public PlayerCheckFlopDetailedHandTypeSuccessReport(String reportName, PokerDataModel model){
        super();
        setReportName(reportName);
        this.setLayout(new BorderLayout());
        setModel(model);
        setChartTitle("Check/Call on flop (all players & hands)");
